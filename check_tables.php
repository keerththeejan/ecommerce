...
$host = 'localhost';
$dbname = 'ecommerce30'; // Using the correct database name
$username = 'root';
$password = '1234';
...
try {
    ...
    // Check if purchases table has payment_status and due_date columns
    $stmt = $pdo->query("SHOW COLUMNS FROM purchases LIKE 'payment_status'");
    if($stmt->rowCount() > 0) {
        echo "\npayment_status column exists in purchases table.\n";
    } else {
        echo "\npayment_status column does not exist in purchases table.\n";
    }
