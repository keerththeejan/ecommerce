...
CREATE TABLE IF NOT EXISTS `contact_info` (
  ...
  `hours_weekdays` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `hours_weekends` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
