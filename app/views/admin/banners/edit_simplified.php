...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo BASE_URL; ?>?controller=banner&action=edit&id=<?php echo $data->id; ?>" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <?php if (!empty($data->image)) : ?>
                                <div class="mb-2">
                                    <img src="<?php echo BASE_URL; ?>public/assets/images/banners/<?php echo $data->image; ?>" 
                                         alt="Current Banner" class="img-thumbnail" style="max-height: 100px;">
                                    <p class="small text-muted mt-1">Current image: <?php echo $data->image; ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <small class="form-text text-muted">Recommended size: 1920x800 pixels. Leave empty to keep current image.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
