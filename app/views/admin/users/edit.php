        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>?controller=user&action=adminEdit&id=<?php echo $user['id']; ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="username" class="form-label">Username</label>
                                    <input type="text" class="form-control <?php echo isset($errors['username']) ? 'is-invalid' : ''; ?>" id="username" name="username" value="<?php echo $user['username']; ?>" required>
