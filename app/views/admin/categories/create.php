                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>?controller=category&action=create" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php echo isset($errors['description']) ? 'is-invalid' : ''; ?>" id="description" name="description" rows="3"><?php echo $data['description']; ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?php echo isset($errors['parent_id']) ? 'is-invalid' : ''; ?>" id="parent_id" name="parent_id">
                                ...
                                <?php foreach($parentCategories as $parentCategory): ?>
                                    <option value="<?php echo $parentCategory['id']; ?>" <?php echo ($data['parent_id'] == $parentCategory['id']) ? 'selected' : ''; ?>>
