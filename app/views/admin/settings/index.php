                    ...
                    <div class="tab-content" id="settingsTabsContent">
                        ...
                        <div class="tab-pane fade" id="store" role="tabpanel" aria-labelledby="store-tab">
                            <form action="<?php echo BASE_URL; ?>?controller=setting&action=updateStore" method="POST">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <label for="store_tax_rate" class="form-label">Tax Rate (%)</label>
                                        <input type="number" step="0.01" class="form-control <?php echo isset($errors['store_tax_rate']) ? 'is-invalid' : ''; ?>" id="store_tax_rate" name="store_tax_rate" value="<?php echo isset($storeSettings['store_tax_rate']) ? $storeSettings['store_tax_rate'] : '18'; ?>" required>
                                        <?php if(isset($errors['store_tax_rate'])): ?>
                                            <div class="invalid-feedback"><?php echo $errors['store_tax_rate']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="store_shipping_flat_rate" class="form-label">Flat Shipping Rate</label>
                                        <input type="number" step="0.01" class="form-control <?php echo isset($errors['store_shipping_flat_rate']) ? 'is-invalid' : ''; ?>" id="store_shipping_flat_rate" name="store_shipping_flat_rate" value="<?php echo isset($storeSettings['store_shipping_flat_rate']) ? $storeSettings['store_shipping_flat_rate'] : '100'; ?>" required>
                                        <?php if(isset($errors['store_shipping_flat_rate'])): ?>
                                            <div class="invalid-feedback"><?php echo $errors['store_shipping_flat_rate']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="store_free_shipping_threshold" class="form-label">Free Shipping Threshold</label>
                                        <input type="number" step="0.01" class="form-control <?php echo isset($errors['store_free_shipping_threshold']) ? 'is-invalid' : ''; ?>" id="store_free_shipping_threshold" name="store_free_shipping_threshold" value="<?php echo isset($storeSettings['store_free_shipping_threshold']) ? $storeSettings['store_free_shipping_threshold'] : '1000'; ?>" required>
                                        <?php if(isset($errors['store_free_shipping_threshold'])): ?>
                                            <div class="invalid-feedback"><?php echo $errors['store_free_shipping_threshold']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="store_inventory_management" name="store_inventory_management" value="1" <?php echo (isset($storeSettings['store_inventory_management']) && $storeSettings['store_inventory_management'] == 1) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="store_inventory_management">Enable Inventory Management</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="store_low_stock_threshold" class="form-label">Low Stock Threshold</label>
                                        <input type="number" class="form-control <?php echo isset($errors['store_low_stock_threshold']) ? 'is-invalid' : ''; ?>" id="store_low_stock_threshold" name="store_low_stock_threshold" value="<?php echo isset($storeSettings['store_low_stock_threshold']) ? $storeSettings['store_low_stock_threshold'] : '5'; ?>" required>
                                        <?php if(isset($errors['store_low_stock_threshold'])): ?>
                                            <div class="invalid-feedback"><?php echo $errors['store_low_stock_threshold']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
