    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3">Edit About Entry</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo URLROOT; ?>/about-store/update/<?php echo $data['about']->id; ?>" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php echo !empty($data['content_err']) ? 'is-invalid' : ''; ?>" 
                                     id="content" name="content" rows="6"><?php echo htmlspecialchars($data['about']->content); ?></textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <?php if (!empty($data['about']->image_path)) : ?>
                                <div class="mb-2">
                                    <img src="<?php echo URLROOT . $data['about']->image_path; ?>" 
                                         alt="Current image" 
                                         class="img-thumbnail" 
                            ...
                            <div class="form-text">Leave empty to keep current image. Max file size: 5MB. Allowed formats: JPG, JPEG, PNG, GIF</div>
