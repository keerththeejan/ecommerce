  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($title ?? 'Privacy Policy'); ?></li>
      </ol>
    </nav>

    <div class="card shadow-sm">
      <div class="card-body p-4">
        <h1 class="h3 mb-4"><?php echo htmlspecialchars($title ?? 'Privacy Policy'); ?></h1>
        <div class="policy-content">
          <?php if (!empty($content)) { echo $content; } else { ?>
            <div class="alert alert-info mb-0">No privacy policy content available.</div>
          <?php } ?>
        </div>
      </div>
    </div>
